...
<div id="header" xmlns="">
    ...
    <div class="mfw-header">
        <div class="header-wrap clearfix">
            <div class="head-logo"><a class="mfw-logo" title="蚂蜂窝自由行"> <img src="../img/header/mafengwo.png"> </a></div>
            <ul class="head-nav" data-cs-t="headnav" id="_j_head_nav">
                ...
                <li class="head-nav-gonglve" data-cs-p="gonglve"><a href="" title="旅游攻略">旅游攻略</a>
                </li>
                <li class="head-nav-sales head-nav-dropdown _j_sales_nav_show" id="_j_nav_sales" data-cs-p="sales">
                    ...
                    <div class="dropdown-menu dropdown-sales hide _j_sales_top" id="_j_sales_panel"
                         data-cs-t="sales_nav">
                        <ul>
                            <li><a target="_blank" href="" data-sales-nav="机票＋酒店">机票＋酒店</a>
                            </li>
                ...
                <li class="head-nav-hotel" data-cs-p="hotel"><a href="" title="酒店">酒店</a>
                </li>
                        ...
                        <div class="panel-wrapper">
                            ...
                            <ul class="nav-list-sub clearfix">
                                <li><a href="" target="_blank"
                                       title="蚂蜂窝旅行家" data-cs-p="traveller">蚂蜂窝旅行家</a></li>
            ...
            <div class="head-search">
                <div class="head-search-wrapper">
                    <div class="head-searchform">
                        ...
                        <a role="button" class="icon-search" id="_j_head_search_link"><img
            ...
            <div class="login-out">
                <a class="weibo-login" href="" title="微博登录" ><img
                        src="../img/header/xinlang.png"></a>
                <a class="qq-login" href="" title="QQ登录"><img
                        src="../img/header/qq.png"></a>
                <a class="weixin-login" href="" title="微信登录" ><img
                        src="../img/header/weixin.png"></a>
                <a id="_j_showlogin" title="登录蚂蜂窝" href="" >登录</a><span
                    class="split">|</span><a href="" title="注册帐号"
            >注册</a>
            </div>
            <!--头部登录 end-->
        </div>
...
<div id="container" data-cs-t="目的地详情页">
    ...
    <div class="row row-placeTop">
        <div class="wrapper">
            ...
            <div class="extra">
                <div class="littleWeather">
                    <a href="" target="_blank">
                        <img src="../img/mudidi-xiangqing/yu.png" width="25"
                             height="25"/>
                        <span>阵雨 24℃~33℃</span>
                    </a>
                </div>
                ...
                <div class="action">
                    <a class="btn-collect" href="" _iswg="0" _mddid="10095" data-act="want_go"
                       data-cs-l="收藏-添加"><img src="../img/mudidi-xiangqing/shoucang.png" width="30"
                                              height="30"/>收藏</a>
                    <a class="btn-been" href="" _ispa="0" _mddid="10095" data-act="set_path"><img
                            src="../img/mudidi-xiangqing/quguo.png" width="30"
                            height="30"/>去过</a>
                </div>
            </div>
            ...
            <div class="crumb">
                <div class="item"><a href="" target="_blank">目的地</a><em>&gt;</em></div>
                <div class="item">
                    <div class="drop">
                        ...
                        <div class="bd">
                            ...
                            <div class="more"><a href="" target="_blank">&gt;&gt;更多地区</a>
                            </div>
                        </div>
                        <!--广西下拉框-->
                    </div>
                ...
                <div class="item cur"><strong>桂林旅游攻略</strong></div>
            </div>
            ...
            <div class="title">
                <h1>桂林</h1>
                <a class="num-photo" href="" target="_blank">(<em>466060</em>张图片)</a>
                <br>
                <span class="en">Guilin City</span>
            </div>
                ...
                <div class="navbar-con">
                    <ul class="navbar clearfix">
                        <li class="navbar-overview city-guide">
                            <a class="navbar-btn" href="" data-cs-l="概况">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/gaikuang%20.png"></i><span>概况</span>
                            </a>
                        </li>
                        <li class="navbar-scenic">
                            <a class="navbar-btn" href="" data-cs-l="景点">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/jingdian-ico.png"></i><span>景点</span> </a>
                        </li>
                        <li class="navbar-hotels">
                            <a class="navbar-btn" href="" data-cs-l="酒店">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/jiudian-ico.png"></i><span>酒店</span> </a>
                        </li>

                        <!--当地玩乐 下拉框-->
                        <li class="navbar-local navbar-dropdown">
                            <a style="position: relative" class="navbar-btn " href="">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/dangdiwanle.png"></i>
                                    <span>                                                                                    当地玩乐
                                                                            </span>
                            ...
                            <div class="navbar-dropmenu hide ">
                                <ul class="navbar-sub clearfix">
                                    <li>
                                        <a href="" target="_blank" data-cs-l="门票">门票</a>
                                    </li>
                                    <li>
                                        <a href="" target="_blank" data-cs-l="一日游">一日游</a>
                                    </li>
                                    <li>
                                        <a href="" target="_blank" data-cs-l="接送机">接送机</a>
                                    </li>
                                    <li>
                                        <a href="" target="_blank" data-cs-l="多日游">多日游</a>
                                    </li>
                                    <li>
                                        <a href="" target="_blank" data-cs-l="酒店套餐">酒店套餐</a>
                                    </li>
                        ...
                        <li class="navbar-sales navbar-dropdown">
                            <a style="position: relative" class="navbar-btn " href="javascript:void(0)">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/jijiu.png"></i>
                                    <span>                                                                                    机 + 酒
                                                                            </span>
                                <em class="drop-corner"></em>
                                <b class="d12"></b>
                            ...
                            <div class="navbar-dropmenu hide ">
                                <ul class="navbar-sub clearfix">
                                    ...
                                    <li>
                                        <a href="" target="_blank"
                                           data-cs-l="半自由行">半自由行</a>
                                    </li>
                                    <li>
                                        <a href="" target="_blank" data-cs-l="机票">机票</a>
                                    </li>
                                    <li>
                                        <a href="http://www.mafengwo.cn/insurance/" target="_blank" data-cs-l="旅游保险">旅游保险</a>
                                    </li>
                                    <li class="special"><b class="d12"></b><a href="" target="_blank">专区</a></li>
                                </ul>
                            </div>
                        ...
                        <li class="navbar-community navbar-dropdown">
                            <a style="position: relative" class="navbar-btn " href="">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/shequ.png"></i>
                                    <span>                                                                                    社区
                                                                            </span>
                                <em class="drop-corner"></em>
                                <b class="d12"></b>
                            ...
                            <div class="navbar-dropmenu hide ">
                                <ul class="navbar-sub clearfix">
                                    <li>
                                        <a href="" data-cs-l="游记">游记</a>
                                    </li>
                                    <li>
                                        <a href="" data-cs-l="行程">行程</a>
                                    </li>
                                    <li>
                                        <a href="" data-cs-l="问答">问答</a>
                                    </li>
                                    <li>
                                        <a href="" target="_blank" data-cs-l="攻略">攻略</a>
                                    </li>
                                    <li class="special"><b class="d12"></b><a href="" target="_blank">专区</a></li>
                                </ul>
                            </div>
                        ...
                        <li class="navbar-food navbar-dropdown">
                            <a style="position: relative" class="navbar-btn " href="">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/canyin.png"></i>
                                    <span>                                                                                    餐饮
                                                                            </span>
                                <em class="drop-corner"></em>
                                <b class="d12"></b>
                            ...
                            <div class="navbar-dropmenu hide ">
                                <ul class="navbar-sub clearfix">
                                    <li>
                                        <a href="" data-cs-l="餐饮">餐饮</a>
                                    </li>
                                    <li>
                                        <a href="" data-cs-l="购物">购物</a>
                                    </li>
                                    <li>
                                        <a href="" data-cs-l="娱乐">娱乐</a>
                                    </li>
                                    <li class="special"><b class="d12"></b><a href="" target="_blank">专区</a></li>
                                </ul>
                            </div>
                        ...
                        <li class="navbar-maps navbar-last">
                            <a class="navbar-btn" href="" target="_blank" data-cs-l="地图">
                                <i class="navbar-icon"><img src="../img/mudidi-xiangqing/ditu-ico.png"></i><span>地图</span> </a>
                        </li>
                    </ul>
                    ...
                    <div class="overview-drop hide">
                        ...
                        <div class="drop-bd">
                            <dl class="clearfix">
                                <dt><a href="" target="_blank">概况</a></dt>
                                <dd>
                                    <a href="" target="_blank">桂林速览</a>
                                    <span>|</span> <a href=""
                                                      target="_blank">最佳旅行时间</a>
                                    <span>|</span> <a href=""
                                                      target="_blank">建议游玩天数</a>
                                    <span>|</span> <a href="" target="_blank">消费水平</a>
                                </dd>
                            </dl>

                            <dl class="clearfix">
                                <dt><a href="" target="_blank">地图</a></dt>
                                <dd>
                                </dd>
                            </dl>

                            <dl class="clearfix">
                                <dt><a href="" target="_blank">桂林必体验</a></dt>
                                <dd>
                                    <a href="" target="_blank">泛舟漓江体验“画中游”</a>
                                    <span>|</span> <a href=""
                                                      target="_blank">阳朔西街的悠闲时光</a>
                                    <span>|</span> <a href="">漓江啤酒鱼的地道吃法</a>
                                    <span>|</span> <a href=""
                                                      target="_blank">阳朔骑行好风光</a>
                                    <span>|</span> <a href="">山水实景演出中的民风民情</a>
                                    <span>|</span> <a href="" target="_blank">到虞山桥寻日落与童趣</a>
                                    <span>|</span> <a href="" target="_blank">看气势恢弘的龙脊梯田</a>
                                </dd>
                            </dl>

                            <dl class="clearfix">
                                <dt><a href="" target="_blank">行前准备</a></dt>
                                <dd>
                                    <a href="" target="_blank">穿衣指南</a>
                                    <span>|</span> <a href="" target="_blank">参考资料</a>
                                    <span>|</span> <a href="" target="_blank">省钱妙计</a>
                                    <span>|</span> <a href=""
                            ...
                            <dl class="clearfix">
                                <dt><a href="" target="_blank">景点</a></dt>
                                <dd>
                                    <a href="" target="_blank">景点概况</a>
                                    <span>|</span> <a href="" target="_blank">桂林地区人气景点Top10</a>
                                    <span>|</span> <a href="" target="_blank">阳朔&amp;漓江人气景点</a>
                                    <span>|</span> <a href="" target="_blank">阳朔&amp;漓江户外爱好者之选</a>
                                    <span>|</span> <a href=""
                                                      target="_blank">龙脊梯田人气景点</a>
                                    <span>|</span> <a href="" target="_blank">周边县景点</a>
                                </dd>
                            </dl>

                            <dl class="clearfix">
                                <dt><a href="" target="_blank">餐饮</a></dt>
                                <dd>
                                    <a href="" target="_blank">餐饮概况</a>
                                    <span>|</span> <a href="" target="_blank">特色美食</a>
                                    <span>|</span> <a href="" target="_blank">经典桂林风味菜馆推荐</a>
                                    <span>|</span> <a href="" target="_blank">桂林米粉人气店Top10</a>
                                    <span>|</span> <a href="" target="_blank">阳朔啤酒漓江鱼人气餐厅Top10</a>
                                </dd>
                            </dl>

                            <dl class="clearfix">
                                <dt><a href="" target="_blank">购物</a></dt>
                                <dd>
                                    <a href="" target="_blank">购物概况</a>
                                    <span>|</span> <a href="" target="_blank">特色商品</a>
                                    <span>|</span> <a href=""
                                                      target="_blank">阳朔特色小店推荐</a>
                                    <span>|</span> <a href="" target="_blank">桂林市人气购物地推荐</a>
                                </dd>
                            </dl>

                            <dl class="clearfix">
                                <dt><a href="" target="_blank">娱乐</a></dt>
                                <dd>
                                    <a href="" target="_blank">娱乐概况</a>
                                    <span>|</span> <a href="" target="_blank">漂流</a>
                                    <span>|</span> <a href="" target="_blank">看演出</a>
                                    <span>|</span> <a href="" target="_blank">攀岩</a>
                                    <span>|</span> <a href="" target="_blank">骑行</a>
                                </dd>
                            </dl>

                            <dl class="clearfix">
                                <dt><a href="" target="_blank">实用信息</a></dt>
                                <dd>
                                    <a href="" target="_blank">语言</a>
                                    <span>|</span> <a href="" target="_blank">银行</a>
                                    <span>|</span> <a href="" target="_blank">邮局</a>
                                    <span>|</span> <a href="" target="_blank">旅行安全</a>
                                </dd>
                            </dl>
                        </div>
                        <!--概况下拉框 end-->
...
<!--*************************************** 详情页第二部分 begin ***************************************-->
    <div class="row row-primary">
        <div class="wrapper">
            <div class="screen clearfix">
                ...
                <div class="r-main">
                    <a class="photo" href="" target="_blank">
                        <img src="../img/mudidi-xiangqing/guilin-datu.jpeg"
                    ...
                    <div class="m-impress">
                        ...
                        <div class="bd clearfix">
                            <ul class="tag" style="height: 140px;overflow: hidden">
                                <li title="3667篇游记提及">
                                    <a href="" target="_blank">山<em>3667</em></a>
                                </li>
                                <li title="1752篇游记提及">
                                    <a href="" target="_blank">漂流<em>1752</em></a>
                                </li>
                                <li title="1581篇游记提及">
                                    <a href="" target="_blank">漓江鱼<em>1581</em></a>
                                </li>
                                <li title="1317篇游记提及">
                                    <a href="" target="_blank">看演出<em>1317</em></a>
                                </li>
                                <li title="1138篇游记提及">
                                    <a href="" target="_blank">桂林米粉<em>1138</em></a>
                                </li>
                                <li title="1135篇游记提及">
                                    <a href="" target="_blank">桂林米粉<em>1135</em></a>
                                </li>
                                <li title="734篇游记提及">
                                    <a href="" target="_blank">蔬果<em>734</em></a>
                                </li>
                                <li title="628篇游记提及">
                                    <a href="" target="_blank">溶洞<em>628</em></a>
                                </li>
                                <li title="555篇游记提及">
                                    <a href="" target="_blank">酿<em>555</em></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="m-nearby">
                        <div class="maps-img"><img src=""></div>
                        <div class="maps-expand hide" data-cs-p="目的地分发">
                            <div id="picArea" class="picArea">
                                <span class="close"></span>
                                <div id="mypic" class="mypic">
                                    <img src="../img/mudidi-xiangqing/ditu.jpeg"
                                         width="525" height="360" border="0" id="mypic1" class="mypic1">
                                    <img src="../img/mudidi-xiangqing/ditu2.jpeg"
                                         width="525" height="360" border="0" id="mypic2" class="mypic2">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="da980" style="padding:20px 0 0;">
                <div class="wrapper">
                    <div style="position:relative"><a target="_blank" href="http://www.mafengwo.cn/ad/r.php?key=Y1pRQA"
                    ><img border="0" src="../img/mudidi-xiangqing/guanggao1.jpeg"/></a><img
    ...
    <!--*************************************** 详情页第三部分 begin ************************************-->
    <div id="pagelet-block-95f29af1de3edbbb063e13a499bc548a" class="pagelet-block" data-api=":mdd:pagelet:recommendsApi"
         data-params="{&quot;iMddid&quot;:&quot;10095&quot;}" data-async="1" data-controller="">
        <div class="row row-feature row-bg">
            <div class="wrapper">
                ...
                <div class="col col-hotel">
                    ...
                    <dl>
                        <dt><a data-title="酒店分区1" class="r-tit" href="" target="_blank"><span
                                class="No">1</span>十字街</a></dt>
                        <dd>
                            <a data-title="酒店分区1" href="" target="_blank">
                                <div class="r-photo">
                                    <img src="../img/mudidi-xiangqing/jiudian.jpeg"
                                         width="296" height="156">
                                </div>
                                <div class="r-text">
                                    <h4 class="percent"><em>41%</em>的游客选择住在这里</h4>
                                    <p>
                                        有<span class="num">166</span>家酒店。
                                        这里是桂林的中心广场，也是市内最繁华热闹的街区。 十字街距离火车站不远，搭乘公交可方便到达...
                                    </p>
                                </div>
                            </a>
                        </dd>
                    ...
                    <dl>
                        <dt><a data-title="酒店分区2" class="r-tit" href="" target="_blank"><span
                                class="No">2</span>火车站周边</a></dt>
                        <dd>
                            <a data-title="酒店分区2" href="" target="_blank">
                                <div class="r-text">
                                    <h4 class="percent"><em>32%</em>的游客选择住在这里</h4>
                                    <p>
                                        有<span class="num">333</span>家酒店。
                                        经济型酒店很多，住宿环境一般但交通很方便。 小客栈偶尔会有宰客的行为，蜂蜂们要多加小心。
                                    </p>
                                </div>
                            </a>
                        </dd>
                ...
                <div class="col col-scenic">
                    <h2 class="hd"><a data-title="景点标题" href="" target="_blank"><i></i>必游景点排行</a>
                    </h2>
                    <dl>
                        <dt>
                        ...
                        <dd>
                            <a data-title="景点1" href="" target="_blank">
                                <div class="r-photo">
                                    <img src="../img/mudidi-xiangqing/jingdian.jpeg"
                                         width="296" height="156">
                                </div>
                                <div class="r-text">
                                            <span class="user" title="lucky_肥高" rel="nofollow">
                                                <img src="">浪人
                                            </span>
                                    &nbsp;“相信很多人前去兴坪无疑是奔着20块人民币背景和九马画山，事实上本人觉得不值100块，才一个半...”
                                </div>
                            </a>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd>
                            <a data-title="景点2" href="" target="_blank">
                                <div class="r-text">
                                            <span class="user" title="﹉桃色禁忌﹎" rel="nofollow">
                                                <img src="">浪人
                                            </span>
                    ...
                    <div class="ft">
                        <a data-title="查看全部景点" class="a-link" href=""><i class="icon-link"></i>327个景点</a>
                    </div>
                </div>
                <!--必游景点排行 end-->
                ...
                <div class="col col-cate">
                    ...
                    <dl>
                        <dt>
                            <a data-title="餐饮1" class="r-tit" href=""><span
                                    class="No">1</span>漓江鱼</a>
                        </dt>
                        <dd>
                            <a data-title="餐饮1" href="">
                                <div class="r-photo">
                                    <img src="../img/mudidi-xiangqing/meishi.jpeg"
                                         width="296" height="156">
                                </div>
                                <div class="r-text">
                    ...
                    <dl>
                        <dt>
                            <a data-title="餐饮2" class="r-tit" href=""><span
                                    class="No">2</span>桂林米粉</a>
                        </dt>
                        <dd>
                    ...
                    <div class="ft">
                        <a data-title="查看全部餐饮" class="a-link" href=""><i class="icon-link"></i>5169个餐厅</a>
                    </div>
                </div>
                <!--必吃美食排行 end-->
                ...
                <ul class="clearfix">
                    <li>
                        <a class="img" href="" target="_blank">
                            <img src="../img/mudidi-xiangqing/ziyouxinggonglue.jpeg"
                                 width="320" height="170">
                        </a>
                        <a class="title" href="" target="_blank">桂林土著，教你如何玩转桂林山水（附经典4日行程推荐）</a>
                        <p>最佳旅游时间</p>
                        <p>桂林精华4日线路推荐</p>
                        <div class="more"><a class="a-link" href=""
                                             target="_blank"><i class="icon-link"></i>查看详情</a></div>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="tn-image">
                                <a href="" target="_blank">
                                    <img class="lazy"
                                         ...
                                         src="../img/mudidi-xiangqing/youji1.jpeg"
                                         style="display: inline;">
                                    <i class="icon-baozang"></i>
                                </a>
                            </div>
                            <div class="tn-wrapper" data-focus="" data-topsort="1" data-star="3">
                                <dl>
                                    <dt class="hasxjicon">
                                        <a class="bzicon" href=""
                                           target="_blank" title="宝藏游记"></a>
                                        <a href="" target="_blank">❤宝藏纪念❤盛夏</a>
                                    </dt>
                                    <dd><a href="" target="_blank">2016年06月23日，我向自己预约了这篇游记，当时我说：
                        ...
                        <div class="tn-item clearfix">
                            <div class="tn-image">
                                <a href="" target="_blank">
                                    <img class="lazy"
                                         width="220" height="150"
                                         src="../img/mudidi-xiangqing/youji2.jpeg"
                                         style="display: inline;">
                                </a>
                            </div>
                            <div class="tn-wrapper" >
                                <dl>
                                    <dt class="hasxjicon">
                                        <a class="fsicon" href=""
                                           target="_blank" title="蜂首游记"></a>
                                        <a href="" target="_blank">【定焦纪实】-兴安不完全纪录</a>
                                    </dt>
                                    <dd><a href="" target="_blank">【题记】
                                        从小在南方长大，只耳闻过北国的秋天，金黄一片，却从未感受过。 尤其是 广州 ，一夜冬风来，从未感受过秋天的金黄与清爽。 于是趁着周末，来到 兴安
                                        ，探索那点点的秋意。 兴安 不大，两天时间却也无法游遍，不完全纪录在此，却依旧心满意足。 因为想拍银杏，所以没...</a></dd>
                                </dl>
                            </div>
                        </div>
                        <!--游记2-->
                        ...
                        <div class="tn-item clearfix">
                            <div class="tn-image">
                                <a href="" target="_blank">
                                    <img class="lazy"
                                         width="220" height="150"
                                         src="../img/mudidi-xiangqing/youji3.jpeg"
                                         style="display: inline;">
                                </a>
                            </div>

                            <div class="tn-wrapper" data-focus="1" data-topsort="0" data-star="3">
                                <dl>
                                    <dt class="hasxjicon">
                                        <a class="fsicon" href=""
                                           target="_blank" title="蜂首游记"></a>
                                        <a href="" target="_blank">没有说走就走的长途旅行，但有说走就走的周末旅行。打个飞的去广西，过个周末就肥来上班儿！——以此纪念黄姚古镇和阳朔的三日短暂小时光</a>
                                    </dt>
                                    <dd><a href="" target="_blank"> 【写在前面的话】
                                        亲，你会为一年只有不到10天年假完全不够去旅行而发愁么？ 亲，你会为手里攥着好几天没用完的年假但却始终被一堆工作压着无从请假从而无法去旅行而郁闷么？
                                        亲，你会为你可以请假的那几天恰巧你男盆友/老公没办法请假从而无法去旅行而沮丧么？ 亲，你会为好...</a></dd>
                                </dl>
                            </div>
                        </div>
                        <!--游记3-->
            ...
            <!--page bar-->
                <div class="_pagebar">
                    <div align="right" class="m-pagination">
                        <span class="count">共<span>101</span>页 / <span>1006</span>条</span>
                        ...
                        <a class="pi pg-next" href="">后一页</a>
                        <a class="pi pg-next" href="">末页</a>
                    </div>
                </div>
            <!--page bar-->
            </div>
...
<div class="row wrapper">
    <div style="position:relative"><a target="_blank" href=""><img border="0" src="../img/mudidi-xiangqing/guanggao.jpeg"/></a><img
            src="../img/mudidi-xiangqing/icon.png"
            style="position:absolute;bottom: 4px;left:4px;width:22px;height:12px;"/></div>
    </div>
</div>
    ...
    <div class="ft-content">
        <div class="ft-info clearfix">
            ...
            <dl class="ft-info-col ft-info-qrcode">
                <dd>
                    <span class="ft-qrcode-tejia"><img src="../img/footer/liangpin.png"></span>
                    <p>蚂蜂窝良品</p>
                </dd>
                <dd>
                    <span class="ft-qrcode-weixin"><img src="../img/footer/weixin.gif"></span>
                    <p>蚂蜂窝官方微信</p>
                </dd>
            </dl>
            <dl class="ft-info-social">
                <dt>关注我们</dt>
                <dd>
                    <a class="ft-social-weibo" target="_blank" href="http://weibo.com/mafengwovip"><i
                            class="ft-social-icon"></i><img src="../img/footer/xinlang.png"></a>
                    <a class="ft-social-qqt" target="_blank" href="http://t.qq.com/mafengwovip"><i
                            class="ft-social-icon"></i><img src="../img/footer/tengxun.png"></a>
                    <a class="ft-social-qzone" target="_blank" href="http://1213600479.qzone.qq.com/"><i
        ...
        <div class="ft-copyright">
            ...
            <p>© 2016 Mafengwo.cn <a href="http://www.miibeian.gov.cn/" target="_blank">京ICP备11015476号</a> 京公网安备110105013401号 京ICP证110318号</p>
