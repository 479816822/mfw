		...
		$(".set_set11").click(function() {
			...
			$.ajax({
				...
				success : function(msg) {
					...
					$(".page_img1111").addClass("page_img111112");
				},
				error : function(msg) {
					//提示输需要入的信息
				}
...
<body>
	...
	<span style="display: none;" id="user_id">${userInfo.userId}</span>
	<div class="topBar">
		<div class="topBarC">
			<!-- 头部-->
			<!-- 后端处理页面和相应的地方-->
			...
			<div class="t_nav">
				<ul id="pnl_nav" data-cs-t="headnav_wo">
					...
					<li class="drop" data-cs-p="other"><strong class="t"><a
							href="/app/hun.php">更多<b></b></a></strong>
						<div class="c">
							<a href="/rent/" target="_blank">当地人</a> <a href=""
								target="_blank">真人兽</a> <a href="" target="_blank">蚂蜂窝高校</a> <a
								href="" target="_blank">照片PK</a> <a href="" target="_blank">蚂蜂窝拍卖行</a>
			...
			<div class="t_search">
				<form method="GET" action="/group/s.php" name="search">
					...
					<li id="pnl_user_msg" data-hoverclass="on"
						...
						<ul id="head-msg-box" class="drop-bd">
							...
							<li><a href="http://www.mafengwo.cn/msg/entry/article"
								rel="nofollow">文章消息</a></li>
							<li><a href="http://www.mafengwo.cn/msg/entry/group"
								rel="nofollow">小组消息</a></li>
							<li><a href="http://www.mafengwo.cn/msg/entry/sys"
								rel="nofollow">系统通知</a></li>
							<li><a href="http://www.mafengwo.cn/msg/entry/ask"
								rel="nofollow">问答消息</a></li>
						</ul></li>
					<li class="ub-item ub-new-msg" id="head-new-msg"></li>
					<li class="account _j_hoverclass" data-hoverclass="on"
						id="pnl_user_set">
						<!--用户的信息头像--> <span class="t"><a class="infoItem" href=""><img
								src="download_img/${userInfo.userHead}" width="32" height="32"
						...
						<div class="uSet c">
							<a href="/rank/lv.php" class="containNum" target="_blank">等级
								...
								<span id="_j_header_honey">${userInfo.userHoney}</span>
							</a> <a href="/user/lv.php#coin" class="containNum hasLine"
								target="_blank">金币<span id="_j_header_coin">${userInfo.userMoney}</span></a>
	...
	word-wrap: break-word;
				...
				<div class="MAvatar">
					<div class="MAvaImg hasAva">
						...
						<!--用户的头像-->
						<!--用户的详细的信息-->
						<img src="download_img/${userInfo.userHead }" height="120"
							width="120" alt="${userInfo.userNick}"><a href=""
							class="MAvaUp"><i class="Mphoto"></i></a></i>
					</div>
					...
					<div class="MAvaInfo clearfix MAvaMyInfo">
						<span class="MAvaLevel flt1">等级：<a href=""
							title="${userInfo.userLevel}" target="_blank">Lv.${userInfo.userLevel }</a></span>
						<span class="MAvaPlace flt1" title="青岛">现居：青岛</span> <span
							class="MAvaSet"><a title="设置" href="" target="_blank"></a></span>
					</div>
					<!-- 用户的个性签名 -->
					<div id="_j_profilearea" class="MAvaProfile">
						<div class="MProfile _j_showintrobox"
							data-intro="${userInfo.userSignature}">
							<pre>${userInfo.userSignature}</pre>
						</div>
						<!-- 用户个性签名的输入 -->
						<!-- 用户个性签名的输入 -->
						...
						<div class="MUsersAtom">
							<ul class="clearfix _j_followlist">
								<li><a href="" target="_blank"> <img
										src="img/img/1.png" height="48" width="48" alt="蜂窝机器人"
										title="蜂窝机器人">
								</a>
									<p>
								...
								<li><a href="" target="_blank"> <img
										src="img/img/2.png" height="48" width="48" alt="蚂蜂窝攻略组"
										title="蚂蜂窝攻略组">
								</a>
									<p>
								...
								<li><a href="" target="_blank"> <img
										src="img/img/3png.png" height="48" width="48" alt="蜂窝机器人2号"
										title="蜂窝机器人2号">
								</a>
									<p>
								...
								<li><a href="" target="_blank"> <img
										src="img/img/4.png" height="48" width="48" alt="蚂蜂窝宝藏办"
										title="蚂蜂窝宝藏办">
								</a>
									<p>
								...
								<li><a href="" target="_blank"> <img
										src="img/img/5.png" height="48" width="48" alt="总编辑时间"
										title="总编辑时间">
								</a>
									<p>
								...
								<li><a href="" target="_blank"> <img
										src="img/img/9.jpeg" height="48" width="48" alt="蚂蜂窝活动君"
										title="蚂蜂窝活动君">
								</a>
									<p>
								...
								<li><a href="" target="_blank"> <img
										src="img/img/7.gif" height="48" width="48" alt="蚂蜂窝长老会"
										title="蚂蜂窝长老会">
								</a>
									<p>
								...
								<li><a href="" target="_blank"> <img
										src="img/img/8.png" height="48" width="48" alt="酒店专家助理"
										title="酒店专家助理">
								</a>
									<p>
			...
			<div class="content flt2">
				<div class="common_block main_links">
					<ul class="clearfix">
						<li><a href="writeTravel" target="_blank"><i class="write_note"></i><span>写游记</span></a></li>
									...
									<dl>
										<dt>
											...
											<a href="" target="_blank" id="_j_coverlink_5663645"><img 
												src="download_img/travel/${trackInfo.traImg}" height="400"
												width="680" alt="封面"></a>
											<div class="hover_item">
												...
												<div class="notes_status">
													...
													<span style="display: none">${trackInfo.traId}</span> <a
														...
														data-japp="note_set_cover" data-iid="5663645"><i></i>设置封面</a>
													<!-- *********************重新打开游记的编辑页进行重新的编辑******************** -->
													<!-- *********************重新打开游记的编辑页进行重新的编辑******************** -->
				...
				<div class="question_answer">
					<div class="question_answer_one">
						<c:forEach items="${anserList}" var="anser">
							<div class="img_123">
								<img alt="" class="img"
									src="download_img/${anser.question.questioner.userHead}">
							</div>
							<div class="img_1234">
								<div class="img_1231">
